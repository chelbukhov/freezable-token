...
contract ADAToken is FreezableToken, BurnableToken {
    string public constant name = "Test ADA Token";
    ...
    modifier allowTransfer() {
        if (msg.sender != CrowdsaleAddress){
            require(now > dateStartTransfer,"All transfers is locked now.");
        }
        _;
    }
...
contract Crowdsale is Ownable {
    ...
    ADAToken public token = new ADAToken(myAddress);
    /**
